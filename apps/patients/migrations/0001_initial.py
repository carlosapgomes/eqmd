    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('ward', models.ForeignKey(blank=True, help_text='Ala onde o paciente está localizado', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='patients', to='patients.ward', verbose_name='Ala')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['patient', 'is_current'], name='patients_pa_patient_3e9076_idx'), models.Index(fields=['record_number'], name='patients_pa_record__dee18d_idx'), models.Index(fields=['effective_date'], name='patients_pa_effecti_470560_idx')],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_current', True)), fields=('patient',), name='unique_current_record_per_patient')],
            },
        ),
        migrations.CreateModel(
            name='Tag',
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('allowed_tag', 'patient'), name='unique_tag_per_patient_per_allowed_tag')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['patient', 'is_active'], name='patients_pa_patient_fc9bb3_idx'), models.Index(fields=['admission_datetime'], name='patients_pa_admissi_1f71b2_idx'), models.Index(fields=['discharge_datetime'], name='patients_pa_dischar_94033d_idx'), models.Index(fields=['admission_type'], name='patients_pa_admissi_6cb2fe_idx')],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_active', True)), fields=('patient',), name='unique_active_admission_per_patient'), models.CheckConstraint(condition=models.Q(('discharge_datetime__isnull', True), ('discharge_datetime__gte', models.F('admission_datetime')), _connector='OR'), name='discharge_after_admission')],
            },
        ),
    ]
