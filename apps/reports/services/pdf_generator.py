"""PDF generator for reports with letterhead, page breaks, and signature section."""
...
class ReportPDFGenerator(HospitalLetterheadGenerator):
    """PDF generator for reports with letterhead, page breaks, and signature section."""
    ...
    def _format_document_date(self, document_date):
        """Format document date in Portuguese."""
        month_names = [
            "janeiro",
            "fevereiro",
            "março",
    ...
    def _build_location_line(self, document_date):
        """Build location line with city, state, and date."""
    ...
    def _create_signature_section(self, doctor_info):
        """Create signature section for the PDF."""
    ...
    def generate_from_report(self, report):
        """Generate PDF from a report instance."""
        content_elements = []

        # Split content by page break token
        parts = report.content.split(PAGE_BREAK_TOKEN)
        ...
        self._document_date = report.document_date
