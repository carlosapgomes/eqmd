    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_name', models.CharField(help_text='Nome da tag adicionada', max_length=100, verbose_name='Nome da Tag')),
                ('tag_color', models.CharField(help_text='Cor da tag em formato hexadecimal', max_length=7, verbose_name='Cor da Tag')),
                ('tag_notes', models.TextField(blank=True, help_text='Observações sobre a atribuição da tag', verbose_name='Observações da Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TagBulkRemoveEvent',
            fields=[
                ('event_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='events.event')),
                ('tag_count', models.PositiveIntegerField(help_text='Número de tags removidas na operação em lote', verbose_name='Quantidade de Tags')),
                ('tag_names', models.TextField(help_text='Lista de nomes das tags removidas, separados por vírgula', verbose_name='Nomes das Tags')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('event_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='events.event')),
                ('tag_name', models.CharField(help_text='Nome da tag removida', max_length=100, verbose_name='Nome da Tag')),
                ('tag_color', models.CharField(help_text='Cor da tag em formato hexadecimal', max_length=7, verbose_name='Cor da Tag')),
                ('tag_notes', models.TextField(blank=True, help_text='Observações que a tag tinha antes da remoção', verbose_name='Observações da Tag')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['is_deleted', 'patient', 'event_datetime'], name='events_even_is_dele_05d7c7_idx'),
        ),
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['is_deleted', 'created_by'], name='events_even_is_dele_73e5d0_idx'),
        ),
        migrations.AddIndex(
            model_name='event',
