...
# Import the Ward model directly
try:
...
class Patient(models.Model):
    ...
    class Meta:
        permissions = [
            ("change_patient_status", "Can change patient status"),
            ("change_patient_personal_data", "Can change patient personal data"),
            ("access_inpatient_data", "Can access inpatient data"),
            ("access_outpatient_data", "Can access outpatient data"),
        ]
