...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-06.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-06-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-06.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-06.md, plus minimal files needed for context.
