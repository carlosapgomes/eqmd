...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-05.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-05-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-05.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-05.md, plus minimal files needed for context.
