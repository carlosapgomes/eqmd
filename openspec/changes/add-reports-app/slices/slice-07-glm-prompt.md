...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-07.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-07-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-07.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-07.md, plus minimal files needed for context.
