...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-03.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-03-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-03.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-03.md, plus minimal files needed for context.
