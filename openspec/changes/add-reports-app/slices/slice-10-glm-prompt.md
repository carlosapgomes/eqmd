...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-10.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-10-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-10.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-10.md, plus minimal files needed for context.
