...
4) Read the slice files:
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-09.md
   - /home/carlos/projects/eqmd/openspec/changes/add-reports-app/slices/slice-09-prompt.md

STRICT SCOPE RULES:
- Only implement what slice-09.md includes.
- Do NOT implement future slices, even if you notice dependencies.
- Only read/modify files explicitly listed in slice-09.md, plus minimal files needed for context.
