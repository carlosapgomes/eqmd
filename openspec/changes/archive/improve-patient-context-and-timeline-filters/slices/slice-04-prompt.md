Execute ONLY Slice 04 as described in `slice-04.md`.
...
4. `openspec/changes/improve-patient-context-and-timeline-filters/slices/slice-04.md`
...
- Replace both the mobile and desktop duplicated patient context blocks in the
  simple note detail page.
- Preserve the current mobile/desktop layout structure.
- Create the focused test module `apps/simplenotes/tests/test_detail_context_ui.py`
  for this slice instead of broadening existing test files unnecessarily.
- Keep simple note-specific metadata and actions outside the shared component,
...
- Do not start H&P or filter work.
- Stop after completion.
- Do not start Slice 05 until the planner reviews your implementation report.
...
6. `## Notable implementation details`
   ...
   - how simple note-specific metadata/actions were kept outside it
