# Phase 06 – Delegated Token Endpoint Prompt

You are implementing Phase 06: Delegated Token Endpoint.

## Instructions
Follow the corresponding docs/06-*.md file exactly.

## Goal
Create POST /auth/api/delegated-token/
