# Phase 09 – Draft Lifecycle Prompt

You are implementing Phase 09: Draft Lifecycle.

## Instructions
Follow the corresponding docs/09-*.md file exactly.

## Goal
Add draft fields to Event and cleanup job
