# Phase 03 – Matrix Identity Binding Prompt

You are implementing Phase 03: Matrix Identity Binding.

## Instructions
Follow docs/03-matrix-identity-binding.md exactly.

## Goal
Create MatrixUserBinding model and verification flow.
