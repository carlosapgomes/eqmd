# Phase 07 – DRF Authentication Backend Prompt

You are implementing Phase 07: DRF Authentication Backend.

## Instructions
Follow the corresponding docs/07-*.md file exactly.

## Goal
Create DelegatedJWTAuthentication
