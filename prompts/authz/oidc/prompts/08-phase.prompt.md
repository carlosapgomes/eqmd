# Phase 08 – Bot API Layer Prompt

You are implementing Phase 08: Bot API Layer.

## Instructions
Follow the corresponding docs/08-*.md file exactly.

## Goal
Create REST API endpoints for bot operations
