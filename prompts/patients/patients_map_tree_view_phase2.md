...
### Step 1: Create Dedicated JavaScript File
...
### Step 2: Enhanced Template with Search and Filters
...
**File**: `static/css/ward_patient_map.css`
...
.ward-tree .ward-branch::before {
    ...
    bottom: 0;
    width: 3px;
    background: linear-gradient(to bottom, var(--bs-medical-primary), var(--bs-medical-secondary));
    opacity: 0.7;
}
...
.capacity-fill.low { background-color: var(--bs-success); }
.capacity-fill.medium { background-color: var(--bs-warning); }
.capacity-fill.high { background-color: var(--bs-danger); }
...
### Step 4: Update Template to Include Assets
...
### Step 5: Add Real-time Refresh Capability
